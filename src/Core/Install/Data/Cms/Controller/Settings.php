...
class Settings extends View {
    ...
    public static function components_main(App $object){
        $name = Settings::name(__FUNCTION__, __CLASS__, '/');
        $name = explode('.', $name);
        $name = implode('/', $name);
        try {
    ...
    public static function components_main_body(App $object){
        $name = Settings::name(__FUNCTION__, __CLASS__, '/');
        try {
            $url = Settings::locate($object, $name);
            return Settings::response($object, $url);
    ...
    public static function components_settings_body(App $object){
        $name = Settings::name(__FUNCTION__, __CLASS__, '/');
        try {
            $url = Settings::locate($object, $name);
            return Settings::response($object, $url);
    ...
    public static function components_add_template_body(App $object){
        $name = Settings::name(__FUNCTION__, __CLASS__, '/');
        try {
            $url = Settings::locate($object, $name);
            return Settings::response($object, $url);
    ...
    public static function components_edit_template_body(App $object){
        $name = Settings::name(__FUNCTION__, __CLASS__, '/');
        try {
            $url = Settings::locate($object, $name);
            return Settings::response($object, $url);
    ...
    public static function components_view_body(App $object){
        $name = Settings::name(__FUNCTION__, __CLASS__, '/');
        try {
            $url = Settings::locate($object, $name);
            return Settings::response($object, $url);
    ...
    public static function components_view_routes_body(App $object){
        $name = Settings::name(__FUNCTION__, __CLASS__, '/');
        try {
            $url = Settings::locate($object, $name);
            return Settings::response($object, $url);
    ...
    public static function controllers_add_template_body(App $object){
        $name = Settings::name(__FUNCTION__, __CLASS__, '/');
        try {
            $url = Settings::locate($object, $name);
            return Settings::response($object, $url);
    ...
    public static function controllers_edit_template_body(App $object){
        $name = Settings::name(__FUNCTION__, __CLASS__, '/');
        try {
            $url = Settings::locate($object, $name);
            return Settings::response($object, $url);
    ...
    public static function plugins_main(App $object){
        $name = Settings::name(__FUNCTION__, __CLASS__, '/');
        $name = explode('.', $name);
        $name = implode('/', $name);
        try {
    ...
    public static function plugins_main_body(App $object){
        $name = Settings::name(__FUNCTION__, __CLASS__, '/');
        try {
            $url = Settings::locate($object, $name);
            return Settings::response($object, $url);
    ...
    public static function plugins_settings_body(App $object){
        $name = Settings::name(__FUNCTION__, __CLASS__, '/');
        try {
            $url = Settings::locate($object, $name);
            return Settings::response($object, $url);
    ...
    public static function plugins_add_template_body(App $object){
        $name = Settings::name(__FUNCTION__, __CLASS__, '/');
        try {
            $url = Settings::locate($object, $name);
            return Settings::response($object, $url);
    ...
    public static function plugins_edit_template_body(App $object){
        $name = Settings::name(__FUNCTION__, __CLASS__, '/');
        try {
            $url = Settings::locate($object, $name);
            return Settings::response($object, $url);
    ...
    public static function plugins_view_body(App $object){
        $name = Settings::name(__FUNCTION__, __CLASS__, '/');
        try {
            $url = Settings::locate($object, $name);
            return Settings::response($object, $url);
    ...
    public static function plugins_view_routes_body(App $object){
        $name = Settings::name(__FUNCTION__, __CLASS__, '/');
        try {
            $url = Settings::locate($object, $name);
            return Settings::response($object, $url);
